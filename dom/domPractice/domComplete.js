...
// Создаём новый элемент, и вставляем в конец document body
...
div.insertAdjacentElement('afterend', header)
// <!-- beforebegin -->
...
// pDiv.children[0].classList.add('text');
pDiv.children[0].classList.remove('text')
// Удалить 1-й параграф
// pDiv.firstElementChild.remove();
pDiv.children[1].remove()
